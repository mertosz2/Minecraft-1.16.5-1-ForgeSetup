...
import net.tutorialsbykaupenjoe.tutorialmod.container.Mod_Container;
...
public class TutorialMod
{
    ...
    public TutorialMod() {
        ...
        Mod_TileEntity.register(eventBus);
        Mod_Container.register(eventBus);
    ...
    private void doClientStuff(final FMLClientSetupEvent event) {
        event.enqueueWork(() ->{
            ScreenManager.registerFactory(Mod_Container.LIGHTNING_CHANELER_CONTAINER.get(),
                    LightningChanelerScreen::new);
