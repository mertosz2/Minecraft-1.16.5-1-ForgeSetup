...
public class LightningChanelerScreen extends ContainerScreen<LightningChanelerContainer> {

    private final ResourceLocation GUI = new ResourceLocation(TutorialMod.MOD_ID,
            "textures/gui/lightning_channeler_gui.png");

    public LightningChanelerScreen(LightningChanelerContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
